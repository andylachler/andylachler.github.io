...
const ProjectPage = ({ projectId = 'autoease', onNavigate }) => {
  ...
  // tileBg-based ink/cream split only applies to flat brand-color banners.
  ...
  const heroMuted = heroPhoto ? 'rgba(242,239,230,0.75)' : (light ? 'rgba(20,33,28,0.5)' : 'rgba(242,239,230,0.5)');
